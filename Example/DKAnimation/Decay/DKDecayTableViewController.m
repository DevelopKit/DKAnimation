...
#import "DKDecayTableViewController.h"
#import "DKMacros.h"

@interface DKDecayTableViewController ()
@property (nonatomic, strong) NSArray *lists;

@end

@implementation DKDecayTableViewController
...
- (void)viewDidLoad {
    ...
    self.lists = @[
            @{kDescription:@"Decay Study",kClassName:@"DKDecayStudyScene"},
            @{kDescription:@"Decay Usage",kClassName:@""}
    ];
}
