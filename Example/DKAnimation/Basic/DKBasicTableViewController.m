...
#import "DKBasicTableViewController.h"
#import "DKMacros.h"

@interface DKBasicTableViewController ()
@property (nonatomic, strong) NSArray *lists;

@end

@implementation DKBasicTableViewController
...
- (void)viewDidLoad {
    ...
    self.lists = @[
            @{kDescription:@"Basic Study",kClassName:@"DKBasicStudyScene"},
            @{kDescription:@"Basic Usage",kClassName:@""}
    ];
}
